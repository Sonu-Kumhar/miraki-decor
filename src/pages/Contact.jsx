    ...
    <div className="text-white">
      ...
      <div className="min-h-screen py-12 px-4 md:px-12 lg:px-24 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-12 mt-20">
          {/* Left: Form */}
          <form className="flex-1 bg-black/40 backdrop-blur-sm border border-white/20 shadow-lg p-8 space-y-6 rounded-lg">
            <div>
              <label className="block text-sm font-semibold text-white">Name *</label>
              <input
                type="text"
                placeholder="Enter Your Name"
                className="w-full mt-2 p-3 border border-gray-600 rounded shadow-sm focus:ring-2 focus:ring-yellow-500 placeholder-gray-300 bg-transparent text-white"
              />
            </div>
            ...
            <div>
              ...
              <select
                className="w-full mt-2 p-3 border border-gray-600 rounded shadow-sm focus:ring-2 focus:ring-yellow-500 text-white bg-black/5"
                defaultValue=""
              >
            ...
            <button
              type="submit"
              className="w-full bg-[#ffcc66] hover:bg-yellow-500 text-black font-semibold py-3 rounded shadow-lg transition"
            >
              Send Message
            </button>
          </form>
          ...
          <div className="flex-1 flex flex-col gap-8">
            {/* Free Consultation */}
            <div className="bg-black/40 backdrop-blur-sm border border-white/20 shadow-lg p-6 rounded-lg">
